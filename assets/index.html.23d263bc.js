import{_ as t,r as e,o,c as r,a as n,b as p,F as c,d as s,e as u}from"./app.716ece8b.js";var l="/assets/dashboard.a8f45c7f.png",i="/assets/dashboard-events-metric.83130c5a.png",k="/assets/dashboard-pageviews-metric.7d29a129.png",b="/assets/dashboard-sessions-metric.0d2a15b5.png",m="/assets/dashboard-users-metric.4cad81b2.png",q="/assets/dashboard-new-users-metric.ee796f59.png",d="/assets/dashboard-overview-bar-chart.8e85d34b.png",y="/assets/dashboard-pageviews-session-metric.5c50f9a0.png",g="/assets/dashboard-sessions-user-metric.1f47760f.png",h="/assets/dashboard-bounce-rate-metric.bd940add.png",f="/assets/dashboard-returning-users-metric.b0546c46.png",_="/assets/dashboard-devices-pie-chart.4d0389d3.png",v="/assets/dashboard-browsers-pie-chart.bfd983b8.png",w="/assets/dashboard-countries-table.f9b319f8.png",x="/assets/dashboard-overview-map.4ba563cd.png";const T={},j=n("h1",{id:"dashboard",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#dashboard","aria-hidden":"true"},"#"),s(" Dashboard")],-1),z=n("p",null,"Kibanalytics has a default dashboard for viewing the collected data.",-1),I=n("p",null,[n("img",{src:l,alt:"Image from images folder"})],-1),Z=s("It can be fully customized within the "),C={href:"https://www.elastic.co/pt/kibana/",target:"_blank",rel:"noopener noreferrer"},B=s("Kibana"),M=s(" interface and also serves as a template for new dashboards. There are many ways to aggregate data, and each project has specific needs and metrics, feel free to modify it and add your own metrics."),S=s("To learn more about Kibana tool and how to use it to customize the dashboard, it is recommended to read the oficial "),K={href:"https://www.elastic.co/guide/en/kibana/current/index.html",target:"_blank",rel:"noopener noreferrer"},V=s("Kibana guide"),E=s("."),N=u('<p>Below are the default dashboard metrics, a brief description, how they were calculated and the Elasticsearch query example.</p><h2 id="events-metric" tabindex="-1"><a class="header-anchor" href="#events-metric" aria-hidden="true">#</a> Events Metric</h2><p><img src="'+i+`" alt="Image from images folder"></p><p>Events dispatched by the tracker client lib. The events metric is calculated by couting the total number of calls to the server collect API in a time range.</p><div class="language-json ext-json line-numbers-mode"><pre class="language-json"><code><span class="token punctuation">{</span>
